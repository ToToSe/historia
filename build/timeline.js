...
(() => {
                ...
                t.exports = function() {
                    ...
                    return function t() {
                        ...
                        var _t = z,
                            ...
                            bt = F,
                            wt = null,
                            kt = x({}, [].concat(W(E), W(L), W(D), W(N), W(I))),
                            xt = null,
                            ...
                            Wt = null,
                            Gt = x({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "summary", "title", "value", "style", "xmlns"]),
                            Zt = null,
                            Yt = s.createElement("form"),
                            Vt = function(t) {
                                Zt && Zt === t || (t && "object" === (void 0 === t ? "undefined" : U(t)) || (t = {}), t = T(t), wt = "ALLOWED_TAGS" in t ? x({}, t.ALLOWED_TAGS) : kt, xt = "ALLOWED_ATTR" in t ? x({}, t.ALLOWED_ATTR) : Tt, Wt = "ADD_URI_SAFE_ATTR" in t ? x(T(Gt), t.ADD_URI_SAFE_ATTR) : Gt, Bt = "ADD_DATA_URI_TAGS" in t ? x(T(Ut), t.ADD_DATA_URI_TAGS) : Ut, Mt = "FORBID_TAGS" in t ? x({}, t.FORBID_TAGS) : {}, Et = "FORBID_ATTR" in t ? x({}, t.FORBID_ATTR) : {}, Ft = "USE_PROFILES" in t && t.USE_PROFILES, Lt = !1 !== t.ALLOW_ARIA_ATTR, Dt = !1 !== t.ALLOW_DATA_ATTR, St = t.ALLOW_UNKNOWN_PROTOCOLS || !1, Nt = t.SAFE_FOR_TEMPLATES || !1, At = t.WHOLE_DOCUMENT || !1, jt = t.RETURN_DOM || !1, Ot = t.RETURN_DOM_FRAGMENT || !1, Rt = !1 !== t.RETURN_DOM_IMPORT, zt = t.RETURN_TRUSTED_TYPE || !1, Ct = t.FORCE_BODY || !1, Pt = !1 !== t.SANITIZE_DOM, Ht = !1 !== t.KEEP_CONTENT, qt = t.IN_PLACE || !1, bt = t.ALLOWED_URI_REGEXP || bt, Nt && (Dt = !1), Ot && (jt = !0), Ft && (wt = x({}, [].concat(W(I))), xt = [], !0 === Ft.html && (x(wt, E), x(xt, C)), !0 === Ft.svg && (x(wt, L), x(xt, j), x(xt, R)), !0 === Ft.svgFilters && (x(wt, D), x(xt, j), x(xt, R)), !0 === Ft.mathMl && (x(wt, N), x(xt, O), x(xt, R))), t.ADD_TAGS && (wt === kt && (wt = T(wt)), x(wt, t.ADD_TAGS)), t.ADD_ATTR && (xt === Tt && (xt = T(xt)), x(xt, t.ADD_ATTR)), t.ADD_URI_SAFE_ATTR && x(Wt, t.ADD_URI_SAFE_ATTR), Ht && (wt["#text"] = !0), At && x(wt, ["html", "head", "body"]), wt.table && (x(wt, ["tbody"]), delete Mt.tbody), n && n(t), Zt = t)
                            },
                        ...
                        var te = "http://www.w3.org/1998/Math/MathML",
                            ...
                            ce = function(t) {
                                ...
                                return t instanceof h && !ae(t) ? (se(t), !0) : "noscript" !== a && "noembed" !== a || !b(/<\/no(script|embed)/i, t.innerHTML) ? (Nt && 3 === t.nodeType && (e = t.textContent, e = g(e, _t, " "), e = g(e, pt, " "), t.textContent !== e && (_(i.removed, {
                                    element: t.cloneNode()
                        ...
                        return i.sanitize = function(t, s) {
                            ...
                            if (It || Vt(s), i.removed = [], "string" == typeof t && (qt = !1), qt);
                                ...
                                if (!jt && !Nt && !At && -1 === t.indexOf("<")) return st && zt ? st.createHTML(t) : t;
                            ...
                            return Nt && (m = g(m, _t, " "), m = g(m, pt, " ")), st && zt ? st.createHTML(m) : m
    ...
    (() => {
        ...
        function L(t) {
            E[t.toLowerCase()] && (t = E[t.toLowerCase()]), t = t.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, (function(t, e, i, a) {
                return e + e + i + i + a + a
            }));
        ...
        function S(t) {
            for (var e = Array.prototype.slice.call(arguments, 1), i = 0, a = e.length; i < a; i++) D(t, e[i] || {});
            return t
        }
        const N = [];
        ...
        const C = (j = 0, O = "_tl_id", function(t) {
            return t[O] = t[O] || ++j, t[O]
        });
        var j, O;
        ...
        function P(t) {
            t = (t = R(t)).toLowerCase();
            for (var e = "Ã£Ã Ã¡Ã¤Ã¢áº½Ã¨Ã©Ã«ÃªÃ¬Ã­Ã¯Ã®ÃµÃ²Ã³Ã¶Ã´Ã¹ÃºÃ¼Ã»Ã±Ã§Â·/_,:;", i = 0, a = e.length; i < a; i++) t = t.replace(new RegExp(e.charAt(i), "g"), "aaaaaeeeeeiiiiooooouuuunc------".charAt(i));
        ...
        function U(t, e, i) {
            var a = function(t, e, i) {
                return i || (i = ""), e && e.length > 30 && (e = e.substring(0, 30) + "â€¦"), i + "<a class='tl-makelink' href='" + t + "' onclick='void(0)'>" + e + "</a>"
            };
        ...
        const G = t => {
            ...
            Z = t => null !== t.w && "" !== t.w ? Math.round(t.w / 16 * 9) : null !== t.h && "" !== t.h ? Math.round(t.h / 9 * 16) : 0;
        let Y = (J = (V = "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ").length, {
            encode: function(t) {
                if ("number" != typeof t || t !== parseInt(t)) throw '"encode" only accepts integers.';
                for (var e = ""; t;) {
                    var i = t % J;
                    t = Math.floor(t / J), e = V[i].toString() + e
                }
                return e
            },
            decode: function(t) {
                ...
                for (var e = 0; t;) {
                    var i = V.indexOf(t[0]);
                    if (i < 0) throw '"decode" can\'t find "' + t[0] + '" in the alphabet: "' + V + '"';
                    var a = t.length - 1;
                    e += i * Math.pow(J, a), t = t.substring(1)
                }
                return e
            }
        });
        ...
        st.extend = function(t) {
            ...
            return t.statics && (S(e, t.statics), delete t.statics), t.includes && (S.apply(null, [a].concat(t.includes)), delete t.includes), t.options && a.options && (t.options = S({}, a.options, t.options)), S(a, t), e.extend = st.extend, e.include = function(t) {
                S(this.prototype, t)
            }, e
        };
        class nt {
            on(t, e, i) {
                if (!e) throw new M("No callback function provided");
            ...
            fire(t, e) {
                ...
                for (var i = D({
                        type: t,
                        target: this
                    }, e), a = this._tl_events[t].slice(), s = 0, n = a.length; s < n; s++) a[s].action ? a[s].action.call(a[s].context || this, i) : A(`no action defined for ${t} listener`);
                return this
            }
        }
            ...
            function I(t, e) {
                ...
                for (c && (a = e.left, s = e.top, delete e.right, delete e.bottom, delete e.left, delete e.top), i = n.length; i--;) {
                    ...
                    for (var L in e) {
                        ...
                        var I, C = v(n[i], L),
                            j = E(e[L]) ? e[L](n[i]) : e[L];
                        "string" != typeof j || !l.test(j) || l.test(C) ? (u[i][L] = "transform" == L ? k(C) : "string" == typeof j && l.test(j) ? T(C).slice(1) : parseFloat(C), m[i][L] = "transform" == L ? k(j, u[i][L]) : "string" == typeof j && "#" == j.charAt(0) ? T(j).slice(1) : A(j, parseFloat(C)), "string" == typeof j && (I = j.match(d)) && (_[i][L] = I[1])) : delete e[L]
                    }
                }
                return D.apply(n, [r, function(t, a, s) {
                    for (i = n.length; i--;)
                        for (var o in c && (s = S(p[i], t), n[i].style.left = s[0] + "px", n[i].style.top = s[1] + "px"), e) a = N(t, _, u, m, o, i), "transform" == o ? n[i].style[f] = x(a) : "opacity" != o || g ? n[i].style[M(o)] = a : n[i].style.filter = "alpha(opacity=" + 100 * a + ")"
                }, o, h])
            }
            return y((function(t) {
                o = t > 1e12 != s() > 1e12
        ...
        class lt {
            ...
            animatePosition(t, e) {
                ...
                this.animator && this.animator.stop(), this.animator = ot(e, i)
            }
            onLoaded() {
        ...
        class ht {
            ...
            disable() {
                ct.removeListener(this._el.drag, this.dragevent.down, this._onDragStart, this), ct.removeListener(this._el.drag, this.dragevent.up, this._onDragEnd, this)
            }
            stopMomentum() {
            ...
            _animateMomentum() {
                ...
                this.options.enable.y && ((this.options.constraint.top || this.options.constraint.bottom) && (t.y > this.options.constraint.bottom ? t.y = this.options.constraint.bottom : t.y < this.options.constraint.top && (t.y = this.options.constraint.top)), e.top = Math.floor(t.y) + "px"), this.options.enable.x && ((this.options.constraint.left || this.options.constraint.right) && (t.x > this.options.constraint.left ? t.x = this.options.constraint.left : t.x < this.options.constraint.right && (t.x = this.options.constraint.right)), e.left = Math.floor(t.x) + "px"), this.animator = ot(this._el.move, e), this.fire("momentum", this.data)
            }
        }
        z(nt);
        var dt, ct = {
                addListener: function(t, e, i, a) {
                    ...
                    if (!t[n]) {
                        var o = function(e) {
                            return i.call(a || t, e || ct._getEvent())
                        };
                        if (f && "dblclick" === e && this.addDoubleTapListener) this.addDoubleTapListener(t, o, s);
                            ...
                            o = function(e) {
                                if (ct._checkMouse(t, e)) return r(e)
                ...
                disableClickPropagation: function(t) {
                    ct.addListener(t, ht.START, ct.stopPropagation), ct.addListener(t, "click", ct.stopPropagation), ct.addListener(t, "dblclick", ct.stopPropagation)
                },
                preventDefault: function(t) {
                    t.preventDefault ? t.preventDefault() : t.returnValue = !1
                },
                stop: function(t) {
                    ct.preventDefault(t), ct.stopPropagation(t)
                },
            ...
            ut = function() {
                ...
                return E.matches = function(t, e) {
                ...
                }, i.type = N, i.isFunction = A, i.isWindow = I, i.isArray = S, i.isPlainObject = O, i.isEmptyObject = function(t) {
                    var e;
                    for (e in t) return !1;
                    return !0
                    ...
                    not: function(e) {
                        ...
                        if (A(e) && e.call !== t) this.each((function(t) {
                            ...
                            var s = "string" == typeof e ? this.filter(e) : R(e) && A(e.item) ? r.call(e) : i(e);
                    ...
                    i.fn[t] = function() {
                        ...
                        return n.length < 1 ? this : this.each((function(t, r) {
                            s = a ? r : r.parentNode, r = 0 == e ? r.nextSibling : 1 == e ? r.firstChild : 2 == e ? r : null, n.forEach((function(t) {
                                ...
                                Z(s.insertBefore(t, r), (function(t) {
        ...
        window.Zepto = ut, void 0 === window.$ && (window.$ = ut),
            function(t) {
                t.zepto.qsa;
                var e, i = 1,
            ...
            }(ut), (dt = ut).fn.serializeArray = function() {
                var t, e = [];
                return dt([].slice.call(this.get(0).elements)).each((function() {
                    var i = (t = dt(this)).attr("type");
                    "fieldset" != this.nodeName.toLowerCase() && !this.disabled && "submit" != i && "reset" != i && "button" != i && ("radio" != i && "checkbox" != i || this.checked) && e.push({
                        name: t.attr("name"),
                        value: t.val()
                    })
                })), e
            }, dt.fn.serialize = function() {
                var t = [];
                return this.serializeArray().forEach((function(e) {
                    t.push(encodeURIComponent(e.name) + "=" + encodeURIComponent(e.value))
                })), t.join("&")
            }, dt.fn.submit = function(t) {
                if (t) this.bind("submit", t);
                else if (this.length) {
                    var e = dt.Event("submit");
        ...
        const mt = ut.getJSON,
            ...
            gt = ["millisecond", "second", "minute", "hour", "day", "month", "year"],
            vt = /^([\+-]?\d+?)(-\d{2}?)?(-\d{2}?)?$/,
            yt = /^([\+-]?\d{4}(?!\d{2}\b))((-?)((0[1-9]|1[0-2])(\3([12]\d|0[1-9]|3[01]))?|W([0-4]\d|5[0-2])(-?[1-7])?|(00[1-9]|0[1-9]\d|[12]\d{2}|3([0-5]\d|6[1-6])))([T\s]((([01]\d|2[0-3])((:?)[0-5]\d)?|24\:?00)([\.,]\d+(?!:))?)?(\17[0-5]\d([\.,]\d+)?)?([zZ]|([\+-])([01]\d|2[0-3]):?([0-5]\d)?)?)?)?$/,
            bt = {
                base: {
            ...
            wt = st.extend({
                ...
                getDisplayDate: function(t, e) {
                    ...
                    t || (t = It.fallback), t.constructor != It && (A("First argument to getDisplayDate must be type Language"), t = It.fallback);
                ...
                isBefore: function(t) {
                    if (!this.data.date_obj.constructor == t.data.date_obj.constructor) throw new M("date_compare_err");
                ...
                floor: function(t) {
                    for (var e = new Date(this.data.date_obj.getTime()), i = 0; i < ft.length; i++)
                        if (ft[i][2](e), ft[i][0] == t) return new wt(e);
                    throw new M("invalid_scale_err", t)
                },
                _getDateData: function() {
                    ...
                    for (var e in D(t, this.data), gt) {
                        if (!R(t[gt[e]]).match(/^-?\d*$/)) throw new M("invalid_date_err", gt[e] + " = '" + t[gt[e]] + "'");
                        var i = parseInt(t[gt[e]]);
                        isNaN(i) && (i = 4 == e || 5 == e ? 1 : 0), t[gt[e]] = i
                    }
                ...
                findBestFormat: function(t) {
                    for (var e = gt, i = 0; i < e.length; i++)
                        if (this.data[e[i]]) return t ? t in bt || (t = "short") : t = "base", bt[t][e[i]];
                    return ""
                },
        ...
        function kt(t) {
            if (t.match(vt)) {
                var e = t.match(vt).slice(1),
                    i = {
                        year: e[0].replace("+", "")
                    };
                return e[1] && (i.month = e[1].replace("-", "")), e[2] && (i.day = e[2].replace("-", "")), i
            }
            if (t.match(yt)) return cls.parseISODate(t);
            if (t.match(/^\-?\d+$/)) return {
                year: t
            };
            var a = {};
            ...
            if (t.match(/\d+\/\d+/) && (s = t.match(/\d+\/\d+/)[0], t = R(t.replace(s, "")), n = s.split("/"), a.month = n[0], a.year = n[1]), t.match(":")) {
                var o = t.split(":");
        ...
        const xt = st.extend({
                initialize: function(t) {
                    if (this.year = parseInt(t), isNaN(this.year)) throw new M("invalid_year_err", t)
                },
                isBefore: function(t) {
        ...
        function Dt(t) {
            return function(e) {
                var i = e.getTime();
                return new xt(Math.floor(i / t) * t)
            }
        }
        const St = [
                ["year", 1, new Dt(1)],
            ...
            Nt = wt.extend({
                initialize: function(t, e, i) {
                    xt == t.constructor ? this.data = {
                        date_obj: t
                    } : (this.data = JSON.parse(JSON.stringify(t)), this._createDateObj()), t.format && !e && (e = t.format), this._setFormat(e, i)
                },
                _createDateObj: function() {
                    var t = this._getDateData();
                    this.data.date_obj = new xt(t.year)
                },
                floor: function(t) {
        ...
        class It {
            ...
            mergeData(t) {
                for (k in Ot.en) t[k] && ("object" == typeof this[k] ? D(t[k], this[k]) : this[k] = t[k])
            }
            formatBigYear(t, e) {
                var i = t.year,
                ...
                if (a) {
                    for (var s = 0; s < a.length; s++) {
                        var n = a[s];
                        if (Math.abs(i / n[0]) > 1) return jt(Math.abs(i / n[0]), n[1])
                    }
                    return i.toString()
                }
                return A("Language file dateformats missing cosmological. Falling back."), jt(i, e)
            }
            _(t, e) {
                let i = this.messages[t] || It.fallback.messages[t] || t;
                if (i.match(At)) {
                    if (!e) throw new M("template_message_without_context");
                    for (let t of i.matchAll(At)) {
                        if (!(t[1] in e)) throw new M("template_message_without_context");
            ...
            formatDate(t, e) {
                return t.constructor == Date ? this.formatJSDate(t, e) : t.constructor == xt ? this.formatBigYear(t, e) : t.data && t.data.date_obj ? this.formatDate(t.data.date_obj, e) : (A("Unfamiliar date presented for formatting"), t.toString())
            }
            formatJSDate(t, e) {
                var i = this,
                    a = function(t, e) {
                ...
                e || (e = "full");
                var s = this.dateformats[e] || It.fallback.dateformats[e];
                s || (s = e);
                var n = t.getDate(),
                    o = t.getDay(),
                    r = t.getMonth(),
                    ...
                    p = s.replace(It.DATE_FORMAT_TOKENS, (function(t) {
        ...
        It.fallback = {
            messages: {}
        }, It.DATE_FORMAT_TOKENS = /d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g;
        var Ot = {
            en: {
        ...
        class zt {
            ...
            getLanguage() {
                if (this.language) {
                    ...
                    A("I18NMixins.getLanguage: this.language should be object, but is " + typeof this.language)
                }
                return Rt
            }
            _(t, e) {
        ...
        class Pt {
            constructor(t, e, i) {
                ...
                }, this.container = t, D(this.options, e), this._el.container = v("div", this.options.message_class), t && (t.appendChild(this._el.container), this._el.parent = t), this.animator = {}, this._initLayout(), this._initEvents()
            }
            updateMessage(t) {
            ...
            _initEvents() {
                ct.addListener(this._el.container, "click", this._onMouseClick, this), ct.addListener(this, "removed", this._onRemove, this)
            }
        }
        ...
        function qt(t) {
            ...
            a && (i = R(a[0]), t = R(t.substring(0, t.lastIndexOf(i))));
            var s = [],
                n = t.match(/^\s*(\d{1,2})(\d{2})\s*$/);
            if (n ? s = n.slice(1) : 1 == (s = t.split(":")).length && (s = t.split(".")), s.length > 4) throw new M("invalid_separator_error");
            let o = s[0];
            if (e.hour = parseInt(o), i && "p" == i.toLowerCase()[0] && 12 != e.hour ? e.hour += 12 : i && "a" == i.toLowerCase()[0] && 12 == e.hour && (e.hour = 0), isNaN(e.hour) || e.hour < 0 || e.hour > 23) throw new M("invalid_hour_err", o);
            if (s.length > 1) {
                let t = s[1];
                if (e.minute = parseInt(t), isNaN(e.minute)) throw new M("invalid_minute_err", t)
            }
            if (s.length > 2) {
                var r = s[2].split(/[\.,]/);
                if ((s = r.concat(s.slice(3))).length > 2) throw new M("invalid_second_fractional_err");
                if (e.second = parseInt(s[0]), isNaN(e.second)) throw new M("invalid_second_err", s[0]);
                if (2 == s.length) {
                    var l = parseInt(s[1]);
                    if (isNaN(l)) throw new M("invalid_fractional_err", s[1]);
                    e.millisecond = 100 * l
                }
            }
            return e
        ...
        Wt().addHook("afterSanitizeAttributes", (function(t) {
        ...
        class Jt {
            constructor(t) {
                if (this.title = "", this.scale = "", this.events = [], this.eras = [], this.event_dict = {}, this.messages = {
                    ...
                    })), Ht(this.events), Ht(this.eras)
                }
            }
            logError(t) {
                A(`logError: ${t}`), this.messages.errors.push(t)
            }
            getErrors(t) {
            ...
            addEvent(t, e) {
                ...
                return void 0 === t.start_date ? (A("Missing start date, skipping event"), console.log(t), null) : (this._processDates(t), this._tidyFields(t), this.events.push(t), this.event_dict[i] = t, e || Ht(this.events), i)
            }
            addEra(t) {
                var e = this._assignID(t);
                if (void 0 === t.start_date) throw new M("missing_start_date_err", e);
            ...
            _assignID(t) {
                var e = t.unique_id;
                return R(e) || (e = t.text ? P(t.text.headline) : null), t.unique_id = function(t, e) {
                    if (e || (e = H(6)), !(e in t)) return e;
                    var i = e.match(/^(.+)(-\d+)?$/)[1],
                        a = [];
            ...
            _makeUniqueIdentifiers(t, e) {
                for (var i = [t], a = 0; a < e.length; a++) R(e[a].unique_id) && (e[a].unique_id = P(e[a].unique_id), -1 == i.indexOf(e[a].unique_id) ? i.push(e[a].unique_id) : e[a].unique_id = "");
                if (i.length != e.length + 1)
                    for (a = 0; a < e.length; a++)
                        if (!e[a].unique_id) {
                            var s = e[a].text ? P(e[a].text.headline) : null;
                            s || (s = H(6)), -1 != i.indexOf(s) && (s = s + "-" + a), i.push(s), e[a].unique_id = s
                        }
            }
            _ensureValidScale(t) {
                if (!this.scale) {
                    ...
                    A(`Determining scale dynamically: ${this.scale}`)
                }
            ...
            _processDates(t) {
                ...
                if (!(t.start_date instanceof e)) {
                    ...
                    if (t.start_date = new e(i), void 0 !== t.end_date && !(t.end_date instanceof e)) {
                        ...
                        s ? (A("End date same as start date is redundant; dropping end date"), delete t.end_date) : t.end_date = new e(a)
                    }
                }
            }
            getEarliestDate() {
            ...
            getLatestDate() {
                ...
                return Ht(t, "date"), t.slice(-1)[0].date
            }
            _tidyFields(t) {
                function e(t, e, i) {
                    i || (i = ""), t.hasOwnProperty(e) || (t[e] = i)
                }
                t.group && (t.group = R(t.group)), t.text || (t.text = {}), e(t.text, "text"), e(t.text, "headline"), Yt(t, Vt, Gt), Yt(t, K, Zt)
            }
        }
        ...
        async function ee(t, e) {
            ...
            t = function(t) {
                ...
                if ("response_not_csv" == t.proxy_err_code) throw new M("Timeline could not read the data for your timeline. Make sure you have published it to the web.");
                ...
                try {
                    if (! function(t) {
                        ...
                        let e = function(t) {
                            ...
                            if (Object.keys(e).includes("Start Date") || Object.keys(e).includes("End Date")) e["Start Date"] && (a.start_date = kt(e["Start Date"])), e["End Date"] && (a.end_date = kt(e["End Date"]));
                            else {
                                if (e.Year && (a.start_date = {
                                    ...
                                    if (!a.start_date) throw new M("invalid_start_time_without_date");
                                    D(a.start_date, qt(e.Time))
                                }
                                if (e["End Time"]) {
                                    if (!a.end_date) throw new M("invalid_end_time_without_date");
                                    D(a.end_date, qt(e["End Time"]))
                                }
                                if (a.start_date && !$t(a.start_date)) throw new M("invalid_date_err");
                                if (a.end_date && !$t(a.end_date)) throw new M("invalid_date_err")
                            }
                            return a
                        }(t);
                        ! function(t, e) {
                    ...
                    if (i.constructor == M) a.errors.push(i);
                    else {
        ...
        class ie {
            constructor(t) {
                if (!t) throw new M("axis_helper_no_options_err");
        ...
        se("human", ft), se("cosmological", St);
        const ne = {
        ...
        class oe {
            constructor(t, e) {
                ...
                this._scale = t.scale, e = D({
                    ...
                    var i = t.getScale(),
                        a = ae[i];
                    if (!a) throw new M("axis_helper_scale_err", i);
            ...
            _computeDefaultSpan(t) {
                if ("human" == t.scale) {
                    ...
                    for (i = ft.length - 1; i >= 0; i--)
                        if (e.hasOwnProperty(ft[i][0])) {
                            var s = ft[ft.length - 1];
                            return ft[i + 1] && (s = ft[i + 1]), s[1]
                        } return 31536e6
                }
                return 2e5
            }
            ...
            getDateFromTime(t) {
                if ("human" == this._scale) return new wt(t);
                if ("cosmological" == this._scale) return new Nt(new xt(t));
                throw new M("time_scale_scale_err", this._scale)
            }
            getMajorScale() {
            ...
            getAxisTickDateFormat(t) {
                return "cosmological" == this._scale ? "compact" : ne[t]
            }
        }
        class re {
            constructor(t) {
                this._el = {
                    ...
                    label: "",
                    rows: 1
                }, this._el.container = v("div", "tl-timegroup"), D(this.data, t), this.animator = {}, this._initLayout(), this._initEvents()
            }
            updateDisplay(t, e) {}
            setRowPosition(t, e) {
            ...
            _initEvents() {
                ct.addListener(this._el.container, "click", this._onMouseClick, this)
            }
        ...
        class le {
            constructor(t, e, i, a) {
                ...
                }, this.active = !1, this.animator = {}, this.has_end_date = !1, D(this.options, a), this._initLayout(), this._initEvents()
            }
            show() {}
            hide() {}
            setActive(t) {}
        ...
        class he {
            constructor(t, e, i) {
                i && this.setLanguage(i), this._el = {
                    ...
                    width: 600,
                    height: 600
                }, this.active = !1, this.animator = {}, this.axis_helper = {}, this.minor_ticks = [], this.major_ticks = [], this._el.container = "object" == typeof t ? t : g(t), D(this.options, e), this._initLayout(), this._initEvents()
            }
            show() {}
            hide() {}
            addTo(t) {
        ...
        class de {
            constructor(t, e, i) {
                this._el = {
                    ...
                    function(t, e) {
                        t.data = S({}, t.data, e), "" === t.data.unique_id && (t.data.unique_id = H(6))
                    }(this, t), D(this.options, e), this._el.container = v("div", "tl-text"), this._el.container.id = this.data.unique_id, this._initLayout(), i && i.appendChild(this._el.container)
            }
            show() {}
            hide() {}
            addTo(t) {
            ...
            _initLayout() {
                ...
                if (this._el.date = v("h3", "tl-headline-date", this._el.headline_container), "" != this.data.text) {
                    var e = "";
                    e += (i = 1 == this.options.autolink ? U(this.data.text) : this.data.text).match(/<p>[\s\S]*?<\/p>/) ? i : "<p>" + i + "</p>", this._el.content = v("div", "tl-text-content", this._el.content_container), this._el.content.innerHTML = e
                }
                var i;
                this.onLoaded()
            }
        ...
        class ce {
            constructor(t, e, i) {
                i && this.setLanguage(i), this._el = {
                    ...
                    caption_height: 0,
                    background: 0
                }, this.animator = {}, D(this.options, e), D(this.data, t), this.options.background || (this._el.container = v("div", "tl-media"), this.data.unique_id && (this._el.container.id = this.data.unique_id), this._initLayout())
            }
            loadMedia() {
                var t = this;
                if (!this._state.loaded) try {
                    ...
                    A("Error loading media for ", this._media), A(t)
                }
            }
            _updateMessage(t) {
        ...
        class ue extends ce {
            ...
            createMedia() {
                ...
                (this.data.url.match(/.png(\?.*)?$/) || this.data.url.match(/.svg(\?.*)?$/)) && (e = "tl-media-item tl-media-image"), this._el.content_item = this.domCreate("img", e, this._el.content), this.data.alt ? this._el.content_item.alt = this.data.alt : this.data.caption && (this._el.content_item.alt = B(this.data.caption)), this.data.title ? this._el.content_item.title = this.data.title : this.data.caption && (this._el.content_item.title = B(this.data.caption)), this._el.content_item.addEventListener("load", (function(e) {
                    t.onMediaLoaded()
                })), this._el.content_item.src = this.getImageURL()
            }
            getImageURL(t, e) {
                return W(this.data.url)
            }
            _updateMediaDisplay(t) {
        ...
        class fe extends ce {
            _loadMedia() {
                var t, e = this;
                this.youtube_loaded = !1, this._el.content_item = this.domCreate("div", "tl-media-item tl-media-youtube tl-media-shadow", this._el.content), this._el.content_item.id = H(7), t = function(t) {
                    var e, i, a, s = [];
                    ...
                    return s
                }(this.data.url), this.media_id = {}, this.data.url.match("v=") ? this.media_id.id = t.v : this.data.url.match("/embed/") ? this.media_id.id = this.data.url.split("embed/")[1].split(/[?&]/)[0] : this.data.url.match(/v\/|v=|youtu\.be\//) ? this.media_id.id = this.data.url.split(/v\/|v=|youtu\.be\//)[1].split(/[?&]/)[0] : A("YOUTUBE IN URL BUT NOT A VALID VIDEO"), this.data.url.match("start=") ? this.media_id.start = X(this.data.url.split("start=")[1]) : this.data.url.match("t=") && (this.media_id.start = X(this.data.url.split("t=")[1])), this.data.url.match("end=") && (this.media_id.end = X(this.data.url.split("end=")[1])), this.media_id.hd = Boolean(void 0 !== t.hd), me("https://www.youtube.com/iframe_api", (function() {
                    e.createMedia()
                }))
            }
            _updateMediaDisplay() {
        ...
        class ve extends ce {
            constructor(t, e, i) {
                super(t, e, i), this.blockquote = Wt().sanitize(this.data.url)
            }
            _loadMedia() {
        ...
        class ye extends ce {
            _loadMedia() {
                var t, e = this;
                this._el.content_item = this.domCreate("div", "tl-media-item tl-media-wikipedia", this._el.content), this._el.content_container.className = "tl-media-content-container tl-media-content-container-text", this.media_id = this.data.url.split("wiki/")[1].split("#")[0].replace("_", " "), this.media_id = this.media_id.replace(" ", "%20"), t = "https://" + this.data.url.split("//")[1].split(".wikipedia")[0] + ".wikipedia.org/w/api.php?action=query&prop=extracts|pageimages&redirects=&titles=" + this.media_id + "&exintro=1&format=json&callback=?", _t({
                    type: "GET",
                    url: t,
                    dataType: "json",
                    success: function(t) {
        ...
        class be extends ce {
            _loadMedia() {
                var t, e = this.options.width || 1e3,
                    ...
                    a = this;
                try {
                    this.establishMediaID(), t = `https://commons.wikimedia.org/w/api.php?action=query&titles=${this.media_id}&prop=imageinfo|entityterms&iiprop=url&&iiurlwidth=${e}&format=json&origin=*&wbetlanguage=${i}`, mt(t, (function(t) {
                        let e = function(t) {
                            let e = {};
            ...
            establishMediaID() {
                ...
                if (!t) throw new M("Invalid Wikipedia Image URL");
                this.media_id = t
            }
            createMedia() {
                var t = this;
                if (this._el.content_item = this.domCreate("img", "tl-media-item tl-media-image tl-media-wikipedia-image tl-media-shadow", this._el.content), this.data.alt) this._el.content_item.alt = this.data.alt;
                    ...
                    pt(`https://commons.wikimedia.org/w/api.php?action=wbgetentities&format=json&ids=${e}&format=json&origin=*`).then((i => {
        ...
        class we extends ce {
            _loadMedia() {
                var t, e = this;
                this._el.content_item = this.domCreate("div", "tl-media-item tl-media-iframe tl-media-soundcloud tl-media-shadow", this._el.content), this.media_id = this.data.url, t = "https://soundcloud.com/oembed?url=" + this.media_id + "&format=js&callback=?", mt(t, (function(t) {
        ...
        class xe extends ce {
            ...
            _updateMediaDisplay() {
                this._state.loaded && (this._el.content_item.style.height = Z({
                    w: this._el.content_item.offsetWidth
                }) + "px")
            }
            _stopMedia() {
        ...
        class Me extends ce {
            _loadMedia() {
                ...
                t = "https://api.twitter.com/1/statuses/oembed.json?id=" + this.media_id + "&omit_script=true&include_entities=true&callback=?", _t({
                    type: "GET",
                    url: t,
                    dataType: "json",
                    success: function(t) {
            ...
            createMedia(t) {
                var e, i, a, s = "",
                    ...
                    o = "",
                    r = this;
                n = t.html.split("</p>&mdash;")[0] + "</p></blockquote>", e = t.author_url.split("twitter.com/")[1], i = (o = t.html.split("</p>&mdash;")[1].split('<a href="')[1]).split('">')[0], a = o.split('">')[1].split("</a>")[0], (n = n.replace(/<a href/gi, '<a target="_blank" rel="noopener" href')).includes("pic.twitter.com") ? (me("https://platform.twitter.com/widgets.js", (function() {
        ...
        class Le extends ce {
            _loadMedia() {
                var t, e = this;
                try {
                    this.establishMediaID(), t = "https://api.flickr.com/services/rest/?method=flickr.photos.getSizes&api_key=" + this.options.api_key_flickr + "&photo_id=" + this.media_id + "&format=json&jsoncallback=?", mt(t, (function(t) {
            ...
            establishMediaID() {
                if (this.data.url.match(/flic.kr\/.+/i)) {
                    ...
                    this.media_id = Y.decode(t)
                } else {
                    var e = "flickr.com/photos/",
                        i = this.data.url.indexOf(e);
                    if (-1 == i) throw new M("flickr_invalidurl_err");
                    var a = i + e.length;
            ...
            _getMeta() {
                var t, e = this;
                t = "https://api.flickr.com/services/rest/?method=flickr.photos.getInfo&api_key=" + this.options.api_key_flickr + "&photo_id=" + this.media_id + "&format=json&jsoncallback=?", mt(t, (function(t) {
        ...
        class De extends ce {
            _loadMedia() {
                var t = this;
                this._el.content_item = this.domCreate("div", "tl-media-item tl-media-documentcloud tl-media-shadow", this._el.content), this._el.content_item.id = H(7), this.data.url.match(/\.html$/) ? this.data.url = this._transformURL(this.data.url) : this.data.url.match(/.(json|js)$/) || A("DOCUMENT CLOUD IN URL BUT INVALID SUFFIX"), me(["https://assets.documentcloud.org/viewer/loader.js", "https://assets.documentcloud.org/viewer/viewer.js"], (function() {
                    t.createMedia()
                }))
            }
            _transformURL(t) {
        ...
        class Ie extends ce {
            ...
            getImageURL() {
                ...
                pt(`${Se}${this.data.url}`).then((t => t.thumbnail_url)).catch((t => {
                    A(`Instagram getImageURL Error: ${t.status} ${t.statusText}`)
                }))
            }
            _getMeta() {
        ...
        class Oe extends ce {
            ...
            _updateMediaDisplay(t) {
                var e = this.options.height,
                    i = 0,
                    a = 0;
                e = h ? this.options.height / 2 : this.options.height - this.options.credit_height - this.options.caption_height - 30, this._el.content_item.style.maxHeight = "none", A(e), A(this.options.width), e > this.options.width ? (A("height is greater"), i = this.options.width + 80 + "px", a = this.options.width + "px") : (A("width is greater"), A(this.options.width), i = e + "px", a = e - 80 + "px"), this.player.style.width = a, this.player.style.height = i, this._el.credit && (this._el.credit.style.width = a), this._el.caption && (this._el.caption.style.width = a)
            }
            _stopMedia() {}
        }
        class Re extends ce {
            constructor(t, e, i) {
                super(t, e, i), this.iframe = Wt().sanitize(this.data.url, {
                    ADD_TAGS: ["iframe"],
        ...
        class ze extends ce {
            ...
            createMedia() {
                ...
                this._el.content_item = this.domCreate("div", "tl-media-item tl-media-image tl-media-imgur", this._el.content), _t({
                    type: "GET",
                    url: e,
                    dataType: "json",
                    success: function(e) {
                        try {
                            ...
                            A("Error processing imgur ajax response")
                        }
                    },
            ...
            _updateMediaDisplay() {
                this._el.content_item.style.width = this.options.width + "px", this._el.content_item.style.height = Z({
                    w: this.options.width
                }) + "px"
            }
        }
        ...
        class Be {
            constructor(t, e) {
                this._el = {
                    ...
                    height: 600,
                    marker_width_min: 100
                }, this.active = !1, this.animator = {}, this.has_end_date = !1, this.ariaLabel = "", D(this.options, e), D(this.data, t), this._initLayout(), this._initEvents()
            }
            show() {}
            hide() {}
            setActive(t) {
            ...
            setHeight(t) {
                var e = 1;
                this._el.content_container.style.height = t + "px", this._el.timespan_content.style.height = t + "px", this._el.content.className = t <= 30 ? "tl-timemarker-content tl-timemarker-content-small" : "tl-timemarker-content", t <= 56 ? x(this._el.content_container, "tl-timemarker-content-container-small") : T(this._el.content_container, "tl-timemarker-content-container-small"), r ? ((e = Math.floor(t / 14)) < 1 && (e = 1), this._text.className = "tl-headline", this._text.style.webkitLineClamp = e) : (e = t / 12, this._text.className = e > 1 ? "tl-headline tl-headline-fadeout" : "tl-headline", this._text.style.height = 12 * e + "px")
            }
            setWidth(t) {
            ...
            getFormattedDate() {
                if (R(this.data.display_date).length > 0) return this.data.display_date;
                let t = "";
            ...
            _initLayout() {
                ...
                this._el.text = v("div", "tl-timemarker-text", this._el.content), this._text = v("h2", "tl-headline", this._el.text), this.data.text.headline && "" != this.data.text.headline ? this._text.innerHTML = $(this.data.text.headline) : this.data.text.text && "" != this.data.text.text ? this._text.innerHTML = $(this.data.text.text) : this.data.media && this.data.media.caption && "" != this.data.media.caption && (this._text.innerHTML = $(this.data.media.caption));
                const s = this.getFormattedDate();
                this.ariaLabel = `${this._text.innerHTML}, ${s}`, this.onLoaded()
            }
            _initEvents() {
                ct.addListener(this._el.container, "click", this._onMarkerClick, this), ct.addListener(this._el.container, "keydown", this._onMarkerKeydown, this), ct.addListener(this._el.container, "blur", this._onMarkerBlur, this)
            }
            _updateDisplay(t, e, i) {
                t && (this.options.width = t), e && (this.options.height = e)
            }
        ...
        class Ue {
            ...
            enable(t) {
                ct.addListener(this._el.drag, this.dragevent.down, this._onDragStart, this), ct.addListener(this._el.drag, this.dragevent.up, this._onDragEnd, this), this.data.pos.start = 0, this._el.move.style.left = this.data.pos.start.x + "px", this._el.move.style.top = this.data.pos.start.y + "px", this._el.move.style.position = "absolute"
            }
            disable() {
                ct.removeListener(this._el.drag, this.dragevent.down, this._onDragStart, this), ct.removeListener(this._el.drag, this.dragevent.up, this._onDragEnd, this)
            }
            ...
            _onDragStart(t) {
                ...
                }, this.data.time.start = (new Date).getTime(), this.fire("dragstart", this.data), ct.addListener(this._el.drag, this.dragevent.move, this._onDragMove, this), ct.addListener(this._el.drag, this.dragevent.leave, this._onDragEnd, this)
            }
            _onDragEnd(t) {
                this.data.sliding = !1, ct.removeListener(this._el.drag, this.dragevent.move, this._onDragMove, this), ct.removeListener(this._el.drag, this.dragevent.leave, this._onDragEnd, this), this.fire("dragend", this.data), this._momentum()
            }
            ...
            _animateMomentum() {
                ...
                this.options.enable.y && ((this.options.constraint.top || this.options.constraint.bottom) && (t.y > this.options.constraint.bottom ? t.y = this.options.constraint.bottom : t.y < this.options.constraint.top && (t.y = this.options.constraint.top)), e.top = Math.floor(t.y) + "px"), this.options.enable.x && (this.options.constraint.left && t.x >= this.options.constraint.left && (t.x = this.options.constraint.left), this.options.constraint.right && t.x < this.options.constraint.right && (t.x = this.options.constraint.right), e.left = Math.floor(t.x) + "px"), this.animator = ot(this._el.move, e), this.fire("momentum", this.data)
            }
        }
        z(Ue, nt);
        class We {
            constructor(t, e, i, a) {
                ...
                }, this.animator = null, this.ready = !1, this._markers = [], this._eras = [], this.has_eras = !1, this._groups = [], this._calculated_row_height = 100, this.current_id = "", this.current_focused_id = "", this.timescale = {}, this.timeaxis = {}, this.max_rows = 6, this.animate_css = !1, this._swipable, D(this.options, i)
            }
            init() {
            ...
            _getTimeScale() {
                ...
                try {
                    ...
                    A("Invalid value for marker_height_min option."), t = 30
                }
                return 0 == t && (A("marker_height_min option must not be zero."), t = 30), this.max_rows = 8, this.max_rows < 1 && (this.max_rows = 1), new oe(this.config, {
                ...
                if (this.options.has_groups)
                    for (var t = this.options.height - this._el.timeaxis_background.offsetHeight, e = Math.floor(t / this.timescale.getNumberOfRows() - this.options.marker_padding), i = (this.timescale.getGroupLabels(), 0), a = 0; i < this._groups.length; i++) {
                        var s = Math.floor(a * (e + this.options.marker_padding)),
                            n = !1;
                        s > t - this.options.marker_padding && (n = !0), this._groups[i].setRowPosition(s, this._calculated_row_height + this.options.marker_padding / 2), this._groups[i].setAlternateRowColor(q(i), n), a += this._groups[i].data.rows
                    }
            }
            _addMarker(t) {
            ...
            _findMarkerIndex(t) {
                var e = -1;
                return ("string" == typeof t || t instanceof String) && (e = F(t, this._markers, "unique_id", e)), e
            }
            _createEras(t) {
                for (var e = 0; e < t.length; e++) {
                    var i = t[e],
                        a = new le(i.start_date, i.end_date, i.headline, this.options);
            ...
            _onKeydown(t) {
                switch (ct.stopPropagation(t), t.key) {
                    case "ArrowUp":
                    case "ArrowRight":
                        this.focusNext();
                        break;
            ...
            _initEvents() {
                this._swipable.on("dragmove", this._onDragMove, this), ct.addListener(this._el.container, "mousewheel", this._onMouseScroll, this), ct.addListener(this._el.container, "DOMMouseScroll", this._onMouseScroll, this), ct.addListener(this._el.container, "keydown", this._onKeydown, this)
            }
            _initData() {
        ...
        class Ge {
            constructor(t, e, i, a) {
                a && this.setLanguage(a), this._el = {
                    ...
                    skinny_size: 650,
                    media_name: ""
                }, this.active = !1, this.animator = {}, D(this.options, e), D(this.data, t), this._initLayout(), this._initEvents()
            }
            show() {
                this.animator = ot(this._el.slider_container, {
            ...
            _initLayout() {
                ...
                this.data.media && this.data.media.url && "" != this.data.media.url && (this.has.media = !0), this.data.text && this.data.text.text && (this.has.text = !0), this.data.text && this.data.text.headline && (this.has.headline = !0), this.has.media && (this.data.media.mediatype = $e(this.data.media), this.options.media_name = this.data.media.mediatype.name, this.options.media_type = this.data.media.mediatype.type, this.options.autolink = this.data.autolink, this._media = new this.data.media.mediatype.cls(this.data.media, this.options, this.getLanguage())), (this.has.text || this.has.headline) && (this._text = new de(this.data.text, {
                    title: this.has.title,
                    language: this.getLanguage(),
                    autolink: this.data.autolink
                }), this._text.addDateText(this.getFormattedDate())), this.has.text || this.has.headline || !this.has.media ? this.has.headline && this.has.media && !this.has.text ? (x(this._el.container, "tl-slide-media-only"), this._text.addTo(this._el.content), this._media.addTo(this._el.content)) : this.has.text && this.has.media ? (this._text.addTo(this._el.content), this._media.addTo(this._el.content)) : (this.has.text || this.has.headline) && (x(this._el.container, "tl-slide-text-only"), this._text.addTo(this._el.content)) : (x(this._el.container, "tl-slide-media-only"), this._media.addTo(this._el.content)), this.onLoaded()
            }
            _initEvents() {}
        ...
        class Ze {
            constructor(t, e, i) {
                this._el = {
                    ...
                    direction: "previous"
                }, this.animator = null, D(this.options, e), D(this.data, t), this._el.container = y("tl-slidenav-" + this.options.direction), h && this._el.container.setAttribute("ontouchstart", " "), this._initLayout(), this._initEvents(), i && i.appendChild(this._el.container)
            }
            update(t) {
                var e = {
                    title: "",
            ...
            _update(t) {
                ...
                const e = $(this.data.title);
                this._el.title.innerHTML = e;
                const i = $(this.data.date);
        ...
        class Ye {
            constructor(t, e, i, a) {
                a && this.setLanguage(a), this._el = {
                    ...
                    dragging: !0,
                    trackResize: !0
                }, "object" == typeof t ? (this._el.container = t, this.options.id = H(6, "tl")) : (this.options.id = t, this._el.container = g(t)), this._el.container.id || (this._el.container.id = this.options.id), this.animator = null, D(this.options, i), D(this.data, e)
            }
            init() {
            ...
            _createSlides(t) {
                for (var e = 0; e < t.length; e++) "" == t[e].unique_id && (t[e].unique_id = H(6, "tl-slide")), this._createSlide(t[e], !1, -1)
            }
            _removeSlide(t) {
            ...
            _findSlideIndex(t) {
                var e = t;
                return ("string" == typeof t || t instanceof String) && (e = F(t, this._slides, "unique_id")), e
            }
            ...
            goTo(t, e, i) {
                ...
                t < this._slides.length && t >= 0 && (this.current_id = this._slides[t].data.unique_id, this.animator && this.animator.stop(), this._swipable && this._swipable.stopMomentum(), e ? (this._el.slider_container.style.left = -this.slide_spacing * t + "px", this._onSlideChange(i)) : this.animator = ot(this._el.slider_container, {
            ...
            _initLayout() {
                x(this._el.container, "tl-storyslider"), this._nav.previous = new Ze({
                    title: "Previous",
                    description: "description"
                }, {
                    direction: "previous"
                }, this._el.container), this._nav.next = new Ze({
                    title: "Next",
                    description: "description"
                }, {
                    direction: "next"
                    ...
                    snap: !0
                }), this._swipable.enable(), this._message = new Pt(this._el.container, {
            ...
            _onSlideAdded(t) {
                A("slideadded"), this.fire("slideAdded", this.data)
            }
            _onSlideRemoved(t) {
            ...
            _fireMouseEvent(t) {
                if (this._loaded) {
                    var e = t.type;
                    e = "mouseenter" === e ? "mouseover" : "mouseleave" === e ? "mouseout" : e, this.hasEventListeners(e) && ("contextmenu" === e && ct.preventDefault(t), this.fire(e, {
                        latlng: "something",
        ...
        class Ve {
            constructor(t, e, i, a) {
                this._el = {
                    ...
                    ease: at,
                    menubar_default_y: 0
                }, this.animator = {}, this.setLanguage(a), D(this.options, i), this._initLayout(), this._initEvents()
            }
            show(t) {
                this.options.duration
            }
            ...
            _initEvents() {
                ct.addListener(this._el.button_forwardtoend, "click", this._onButtonForwardToEnd, this), ct.addListener(this._el.button_backtostart, "click", this._onButtonBackToStart, this), ct.addListener(this._el.button_zoomin, "click", this._onButtonZoomIn, this), ct.addListener(this._el.button_zoomout, "click", this._onButtonZoomOut, this)
            }
            _updateDisplay(t, e, i) {
                t && (this.options.width = t), e && (this.options.height = e)
            }
        ...
        class Xe {
            constructor(t, e, i) {
                if (i || (i = {}), this.ready = !1, this._el = {
                        ...
                        timenav: {},
                        menubar: {}
                    }, i.lang && !i.language && (i.language = i.lang), this.language = Rt, this._storyslider = {}, this._timenav = {}, this._menubar = {}, this._loaded = {
                        storyslider: !1,
                        timenav: !1
                        ...
                        soundcite: !1
                    }, this.animator_timenav = null, this.animator_storyslider = null, this.animator_menubar = null, this.message = new Pt(this._el.container, {
                        message_class: "tl-message-full"
                    }), "string" == typeof i.default_bg_color) {
                    var a = L(i.default_bg_color);
                    a ? i.default_bg_color = a : (delete i.default_bg_color, A("Invalid default background color. Ignoring."))
                }
                var s, n;
                D(this.options, i), this.options.script_path || (this.options.script_path = this.determineScriptPath()), i.soundcite && this.on("ready", (() => {
                    A("Loading Soundcite resources "), _e("https://cdn.knightlab.com/libs/soundcite/latest/css/player.css"), me("https://cdn.knightlab.com/libs/soundcite/latest/js/soundcite.min.js")
                    ...
                    this.updateDisplay()
                }.bind(this)), this.options.debug && (n = console.log, N.push(n)), x(this._el.container, "tl-timeline"), this._el.container.setAttribute("tabindex", "0"), this._el.container.setAttribute("role", "region"), this._el.container.setAttribute("aria-label", this._("aria_label_timeline")), this.options.is_embed && x(this._el.container, "tl-timeline-embed"), this.options.is_full_embed && x(this._el.container, "tl-timeline-full-embed"), this._loadLanguage(e)
            }
            _loadStyles() {
                let t = null,
                    e = null;
            ...
            _initData(t) {
                "string" == typeof t ? async function(t, e) {
                    let i = null,
                        a = {};
                    if ("function" == typeof e ? i = e : "object" == typeof e && (a = e, i = e.callback, "function" == typeof a.callback && (i = a.callback)), !i) throw new M("Second argument to makeConfig must be either a function or an object which includes a 'callback' property with a 'function' type value");
                    var s, n;
                    if (te(t)) {
                        try {
                            n = await async function(t, e) {
                                if (!e.sheets_proxy) throw new M("Proxy option must be set to read data from Google");
                                var i = await ee(t, e.sheets_proxy);
                                if (i) return i
                            }(t, a)
                        } catch (t) {
                            return s = new Jt, "NetworkError" == t.name ? s.logError(new M("network_err")) : "TLError" == t.name ? s.logError(t) : s.logError(new M("unknown_read_err", t.name)), void i(s)
                        }
                        if (s = new Jt(n), n.errors)
                        ...
                        error: function(t, e, a) {
                            s = new Jt, a = "parsererror" == e ? new M("invalid_url_err") : new M("unknown_read_err", e), s.logError(a), i(s)
                        }
                    })
                }(t, {
                    callback: function(t) {
                ...
                }): Jt == t.constructor ? this.setConfig(t) : this.setConfig(new Jt(t))
            }
            _translateError(t) {
                return t.hasOwnProperty("stack") && A(t.stack), t.message_key ? this._(t.message_key) + (t.detail ? " [" + t.detail + "]" : "") : t
            }
            showMessage(t) {
                this.message ? this.message.updateMessage(t) : (A("No message display available."), A(t))
            }
            determineScriptPath() {
                let t = null;
                if (Je) t = Je;
            ...
            _updateDisplay(t, e, i) {
                ...
                i && (n = i), this.options.width = this._el.container.offsetWidth, this.options.height = this._el.container.offsetHeight, this.options.width <= this.options.skinny_size ? (o += " tl-skinny", this.options.layout = "portrait") : this.options.width <= this.options.medium_size ? (o += " tl-medium", this.options.layout = "landscape") : this.options.layout = "landscape", f && (this.options.layout = (a = "portrait", window.innerWidth > window.innerHeight && (a = "landscape"), Math.abs(window.orientation), a)), h ? (o += " tl-mobile", this.options.timenav_height = this._calculateTimeNavHeight(t, this.options.timenav_mobile_height_percentage)) : this.options.timenav_height = this._calculateTimeNavHeight(t), "portrait" == this.options.layout ? o += " tl-layout-portrait" : o += " tl-layout-landscape", this.options.storyslider_height = this.options.height - this.options.timenav_height, s = "top" == this.options.timenav_position ? Math.ceil(this.options.timenav_height) / 2 - this._el.menubar.offsetHeight / 2 - 19.5 : Math.round(this.options.storyslider_height + 1 + Math.ceil(this.options.timenav_height) / 2 - this._el.menubar.offsetHeight / 2 - 17.5), e ? (this._el.timenav.style.height = Math.ceil(this.options.timenav_height) + "px", this.animator_storyslider && this.animator_storyslider.stop(), this.animator_storyslider = ot(this._el.storyslider, {
                    height: this.options.storyslider_height + "px",
                    duration: n / 2,
                    easing: it
                }), this.animator_menubar && this.animator_menubar.stop(), this.animator_menubar = ot(this._el.menubar, {
                    top: s + "px",
                    duration: n / 2,
                    easing: it
            ...
            _updateHashBookmark(t) {
                if (t) {
                    ...
                    console.log(e, t, this.current_id)
            ...
            updateDisplay() {
                this.ready ? this._updateDisplay() : A("updateDisplay called but timeline is not in ready state")
            }
            focusContainer() {
            ...
            _initGoogleAnalytics() {
                var t, e, i, a, s;
                t = window, e = document, i = "script", t.GoogleAnalyticsObject = "ga", t.ga = t.ga || function() {
                    (t.ga.q = t.ga.q || []).push(arguments)
                }, t.ga.l = 1 * new Date, a = e.createElement(i), s = e.getElementsByTagName(i)[0], a.async = 1, a.src = "//www.google-analytics.com/analytics.js", s.parentNode.insertBefore(a, s), ga("create", this.options.ga_property_id, "auto"), ga("set", "anonymizeIp", !0)
            }
            _initAnalytics() {
